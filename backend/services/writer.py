...
【世界观必现★每拍至少一处★】
世界观是这部作品的灵魂——这不是严肃历史，而是一个被污染的三国游戏世界。
"游戏感"和"诡异感"必须每一拍都让观众看到，不能只演历史剧情。每拍至少
包含下列之一：
1.诡异细节：时间错乱（端午大雪）、空间错乱（小沛又移动了、袁术在东海）、
  角色重复同一句话（像卡住的NPC）、强烈的既视感（这一幕仿佛之前发生过）
2.天意在场：[SYS]系统通知（冰冷机械）、[ERR]世界错误（一闪而过）、无形的
  力量推着剧情走（角色"不由自主"地说了/做了不该做的事）
3.NPC感：角色严格按"人设"演出（曹操必然多疑、刘备必然仁义，像被写好
  的剧本）、灵魂锁链的诡异（关张莫名追随刘备、关羽一死张飞刘备接连出事）
4.察觉真相的疯话：曹操/刘备/司马懿偶尔说出一句仿佛看穿世界的话（"我总觉得
  ……有什么东西在看着我们""这世道，不对"），但绝不解释、一带而过
注意：世界观元素只能通过"现象"呈现，角色浑然不觉（鱼水原则），诡异感是
给观众的——角色越觉得正常，观众越觉得瘆得慌。

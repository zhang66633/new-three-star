...
3. 文风（网文吐槽风·毒舌旁白）：语言利落、短句短段、一行一镜头，画面感保留但忌堆叠意象、忌抒情长句。具体执行规则：
   - 叙述者是"看戏的损友"：世界越惨旁白越带劲，NPC 越一本正经越要扒他一层滑稽——严肃场面先幽默后紧张、先搞笑再出血；
   - 玩家内心是"懒洋洋的吐槽"：见惯不怪、毒舌但不刻薄，心里悄悄嘀咕（如"好家伙""您这是认真的吗""行吧"），绝不 meta、不下结论、不点破世界不对劲；
   - 用词可以土、可以俗、可以损，但绝不煽情、绝不诉苦、绝不上价值；幽默要自然，像朋友聊天随口吐槽，不是刻意抖包袱；
   - 感官覆盖至少两类（视觉/听觉优先），以动作、对话推进。

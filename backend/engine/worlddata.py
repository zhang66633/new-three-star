...
# 边界对齐时间线事件语义点（B-⑤）：
#   P1 黄金乱起收在 188-12（黄金军 184-10 即"平息"，之后是余波，不再到 189 年）——
#   旧边界 189-07 会让 189-01~07 拿到"黄金军摸过来"的 184 内容（时代错乱）
#   P2 董卓乱政从 189-01 起（前夜：灵帝驾崩/何进被杀/十常侍之乱，8 月董卓才进京）
#   P2 到 190-12 → P3 191-01 起。董卓伏诛（192）场景章归 P4、日期章归 P3。
PHASES = [
